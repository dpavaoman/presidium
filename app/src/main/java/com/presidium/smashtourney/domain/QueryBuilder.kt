...
import com.presidium.smashtourney.EventsByTournamentQuery
import com.presidium.smashtourney.StandingsByEventQuery
import com.presidium.smashtourney.TournamentsByVideogameQuery
...
//        val response = StandingsByEventQuery("1").parseJsonResponse(jsonReader)
//        val data: StandingsByEventQuery.Data? = response.data
...
//        val jsonReader = Buffer().writeUtf8(responseString).jsonReader()
//        val response = EventsByTournamentQuery("1").parseJsonResponse(jsonReader)
